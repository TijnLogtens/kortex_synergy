...
class PrecodedCartesianPoseSwitching:
    def __init__(self):
        try:
            rospy.init_node('precoded_cartesian_pose_switching')
    ...
    def main(self):
        ...
        if success:
            ...
            #*******************************************************************************
            # Send Pose 1
            success &= self.send_pose("pose1", 1001, 0.374, 0.081, 0.450, -57.6, 91.1, 2.3)

            # Send Pose 2
            success &= self.send_pose("pose2", 1002, 0.374, 0.081, 0.3, -57.6, 91.1, 2.3)

            # Send Pose 3
            success &= self.send_pose("pose3", 1003, 0.45, 0.081, 0.3, -57.6, 91.1, 2.3)
...
if __name__ == "__main__":
    ex = PrecodedCartesianPoseSwitching()
    ex.main()
