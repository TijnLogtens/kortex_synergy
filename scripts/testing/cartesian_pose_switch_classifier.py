...
class ClassifierCartesianPoseSwitching:
    def __init__(self):
        try:
    ...
    def pose_callback(self, data):
        ...
        if pose_value == 1:
            self.send_pose("pose1", 1001, 0.45, 0.081, 0.450, 60.6, 91.1, 2.3)
        elif pose_value == 2:
            self.send_pose("pose2", 1002, 0.3, 0.81, 0.2, -57.6, 91.1, 2.3)
        elif pose_value == 3:
    ...
    def main(self):
        ...
        if success:
            ...
            try:
                subprocess.Popen(["rosrun", "kortex_synergy", "classified_pose_publisher.py"])
            except OSError:
...
if __name__ == "__main__":
    cps = ClassifierCartesianPoseSwitching()
    cps.main()
    rospy.spin()
