...
class DiscreteControl:
    ...
    def pose_callback(self, data):
        ...
        if act != None: #and cur_pose != None:
            self.send_pose("Pose "+str(self.pose_count), self.pose_count, self.pose['x'], self.pose['y'], self.pose['z'], self.pose['th_x'], self.pose['th_y'], self.pose['th_z'])
        else:
